        ...
        <div class="wrapper">
            <nav>
                ...
                <ul class="menu-navbar" style="margin-bottom: 0px;">
                    ...
                    <li>
                        <a href="<?= base_url('Admin/profile_akunAdmin') ?>" style="color: #8B4E6D; font-weight: 700;">Profile Akun</a>
                    </li>
                    <li id="button-login">
            ...
            <div class="col-lg-5  pb-4 text-md-center">
                <div class="Panel-B">
                    <div style="overflow: hidden;" class="p-0" id="gambar_profile">
                        <img src="<?php echo base_url(); ?>assets/images/Placeholder/doctor4.jpg" alt="" style="width: 700px;">
                    </div>
                </div>
            </div>
